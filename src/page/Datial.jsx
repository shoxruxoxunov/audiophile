                ...
                <div className="container md:flex md:gap-[125px]">
                  ...
                  <div>
                    ...
                    <ul>
                      ...
                      <li className="md:flex items-center md:gap-[10px] md:mb-[8px]">
                        <span className="text-[#D87D4A] font-bold text-[15px] md:w-[15px]">
                      ...
                      {/* <li className="md:flex md:items-center md:gap-[10px] md:mb-[8px]">
                        ...
                        <p className="text-[#000000] font-medium text-[15px] md:w-[180px] opacity-[0.5]">
                    ...
                    <div>
                      ...
                      <div className="md:flex md:flex-col md:items-center md:pt-[40px]">
                        ...
                        <Link
                          ...
                          className="btn md:btn-md bg-[#D87D4A] text-white"
                        >
                          See Product
                        </Link>
                      </div>
